        ...
        <div class="row text-center mx-md-0 mx-1 mt--1 mb--1">
            <div class="col-md-4 offset-md-2 ">
                <div class="feature feature--featured feature-2 boxed boxed--border bg--white text-left">
                    <a href="tel:1300503391" class="text-black">
                        <i class="fas fa-phone-alt text-black fa-2x icon-width-13"></i>1300 50 33 91
                    </a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature feature--featured feature-2 boxed boxed--border bg--white text-left">
                    <a href="mailto:admin@repanet.com.au" class="text-black">
                        <i class="far fa-envelope text-black fa-2x icon-width-13"></i>admin@repanet.com.au
                    </a>
                </div>
            </div>
        </div>
